...
<div class={`w-full h-10 flex justify-center border-b-1 border-solid ${isPinned?'absolute z-1':''}`}>
  <NavigationMenu.Root viewport={false}>
    <NavigationMenu.List>
      ...
      <NavigationMenu.Content>
        <ul
        class="grid gap-2 p-2 md:w-[400px] lg:w-[600px] lg:grid-cols-[.75fr_1fr]"
        >
        <li class="row-span-3">
          <NavigationMenu.Link
